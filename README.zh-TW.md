...
| ArcFace | 人臉（MS1MV2）| 0.640 | 40.2% | 0.51 | 度量學習有幫助，但仍偏人臉 |
| FaceNet | 人臉（VGGFace2）| 0.614 | 42.2% | 0.41 | 對人臉過度專精 |

**核心發現**：人臉專用模型（FaceNet、ArcFace）在靈長類臉上表現*更差*。自監督學習（DINOv2）跨物種泛化最佳。ArcFace 的度量學習（角度間距）比 FaceNet 有幫助，但仍無法勝過不需標籤的 DINOv2。
